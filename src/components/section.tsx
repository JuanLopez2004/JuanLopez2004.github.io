...
export default function Section({ title, content, content2, content3, imageSrc, altText, whiteBg, grayBg, reverse, twoColumn, link1, link2, link3, link4, link1Label }: IntroBodyProps) {
	return (
		<>
